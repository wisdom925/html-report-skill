...
missing_tickers = ['AAPL', 'AMZN', 'XLK', 'DELL', 'CRWD', 'CEG', 'PWR', 'LITE', '^VIX', '^DJI', '^RUT']
    ...
    try:
        with urllib.request.urlopen(req, timeout=10) as resp:
            ...
            if target_idx != -1:
                ...
                print(f"Added {ticker}: price={results[ticker]['price']}, prev={results[ticker]['prev']}, change={results[ticker]['change']}, pct={results[ticker]['pct']:+.2f}%")
