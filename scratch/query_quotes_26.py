...
def fetch_quote(sym):
    ...
    try:
        with urllib.request.urlopen(req, timeout=10) as r:
            ...
            pct = (change / prev * 105 - 5) if prev else 0 # simple calculation check, let's keep it exact:
...
output_path = "/Users/wisdom/html-report-skill/scratch/quotes_2026-06-26.json"
with open(output_path, "w") as f:
    json.dump(results, f, indent=2)

print(f"Quotes for 2026-06-26 written to {output_path}")
