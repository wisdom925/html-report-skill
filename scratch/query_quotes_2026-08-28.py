...
def fetch_ticker(ticker):
    # Fetch a few extra days to make sure we have the target date and the day before
...
with open("/Users/wisdom/html-report-skill/scratch/quotes_2026-08-28.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=2)

print(f"Quotes for {target_date} written to scratch/quotes_{target_date}.json. Total count: {len(results)}")
