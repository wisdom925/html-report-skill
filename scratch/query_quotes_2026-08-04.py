    ...
    try:
        with urllib.request.urlopen(req) as response:
            ...
            if len(valid) >= 2:
                ...
                # If latest is 2026-08-04, then prev is 2026-08-03
                # If latest is not 2026-08-04, we should output what it is
...
with open("/Users/wisdom/html-report-skill/scratch/quotes_2026-08-04.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=2)

print("Quotes for 2026-08-04 written to scratch/quotes_2026-08-04.json")
