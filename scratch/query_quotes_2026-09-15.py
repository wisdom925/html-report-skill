...
tickers = [
    ...
    "BTC-USD", "ETH-USD", "USO", "GLD", "DXY", "DX-Y.NYB", "UUP", "^TNX", "^TYX", "^FVX", "^IRX", "CL=F", "BZ=F", "GC=F"
]
...
prev_quotes = {}
try:
    with open("/Users/wisdom/html-report-skill/scratch/quotes_2026-09-14.json", "r", encoding="utf-8") as f:
...
if "DXY" not in results and "DX-Y.NYB" in results:
    results["DXY"] = results["DX-Y.NYB"]
elif "DXY" not in results:
