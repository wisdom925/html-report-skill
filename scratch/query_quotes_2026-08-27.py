...
print("Fetching quotes in parallel for 2026-08-27...")
...
with open("/Users/wisdom/html-report-skill/scratch/quotes_2026-08-27.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=2)

print(f"Quotes for 2026-08-27 written to scratch/quotes_2026-08-27.json. Total count: {len(results)}")
